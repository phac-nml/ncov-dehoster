...
def init_parser():
    ...
    parser.add_argument('-f', '--file', required=True, help='Composite Reference SAM file of mapped reads')
...
def get_reads_to_remove(samfile_path, input_mapping_quality, contig_ID, reads_to_remove=set(), count=0):
